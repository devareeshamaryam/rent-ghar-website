      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center gap-4">
            ...
            <Link href="/profile" className="text-white hover:text-[#f0c040] transition-colors duration-200" aria-label="Profile">
        ...
        {mobileMenuOpen && (
          <div className="md:hidden border-t border-white/10 py-4 flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-3 pt-2 border-t border-white/10">
              <a href="tel:+923111445559" className="flex items-center gap-2 text-white text-sm font-medium hover:text-[#f0c040] transition-colors">
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
                    d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                </svg>
              ...
              <Link href="/profile" className="flex items-center gap-2 text-white text-sm font-medium hover:text-[#f0c040] transition-colors" onClick={() => setMobileMenuOpen(false)}>
