  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const res  = await fetch('/api/areas', {
        ...
        body:    JSON.stringify({ name: name.trim(), city: cityId }),
      })
  ...
  return (
    <div className="p-6 max-w-lg mx-auto">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h1 className="text-xl font-semibold text-gray-800">Add Area</h1>
          <p className="text-xs text-gray-400 mt-0.5">Add a new area under a city</p>
        </div>
      </div>
