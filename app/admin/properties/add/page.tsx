...
const FEATURES: FeatureDef[] = [
  { key: 'tv_lounge',       label: 'TV Lounge',       icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6"><rect x="2" y="3" width="20" height="14" rx="2"/><path d="M8 21h8M12 17v4"/></svg> },
  { key: 'kitchen',         label: 'Kitchen',          icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6"><rect x="3" y="3" width="18" height="18" rx="2"/><path d="M3 9h18M9 21V9"/></svg> },
  { key: 'electricity',     label: 'Electricity',      icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"/></svg> },
  { key: 'water_supply',    label: 'Water Supply',     icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6"><path d="M12 2.69l5.66 5.66a8 8 0 11-11.31 0z"/></svg> },
  { key: 'gas',             label: 'Gas',              icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6"><path d="M8.5 14.5A2.5 2.5 0 0011 12c0-1.38-.5-2-1-3-1.072-2.143-.224-4.054 2-6 .5 2.5 2 4.9 4 6.5 2 1.6 3 3.5 3 5.5a7 7 0 11-14 0c0-1.153.433-2.294 1-3a2.5 2.5 0 002.5 2.5z"/></svg> },
  { key: 'security',        label: 'Security',         icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg> },
  { key: 'parking',         label: 'Parking',          icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6"><rect x="3" y="3" width="18" height="18" rx="2"/><path d="M9 17V7h4a3 3 0 010 6H9"/></svg> },
  { key: 'internet',        label: 'Internet',         icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6"><circle cx="12" cy="12" r="10"/><path d="M2 12h20M12 2a15.3 15.3 0 014 10 15.3 15.3 0 01-4 10 15.3 15.3 0 01-4-10 15.3 15.3 0 014-10z"/></svg> },
  { key: 'generator',       label: 'Generator',        icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6"><circle cx="12" cy="12" r="3"/><path d="M12 1v4M12 19v4M4.22 4.22l2.83 2.83M16.95 16.95l2.83 2.83M1 12h4M19 12h4M4.22 19.78l2.83-2.83M16.95 7.05l2.83-2.83"/></svg> },
  { key: 'lift',            label: 'Lift / Elevator',  icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6"><rect x="5" y="2" width="14" height="20" rx="2"/><path d="M9 10l3-3 3 3M9 14l3 3 3-3"/></svg> },
  { key: 'swimming_pool',   label: 'Swimming Pool',    icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6"><path d="M2 12h20M2 18c1.5-2 3-2 4.5 0S9 20 10.5 18s3-2 4.5 0S18 20 19.5 18 22 16 22 16"/><path d="M7 12V6a3 3 0 013-3h0a3 3 0 013 3v1"/><line x1="16" y1="9" x2="20" y2="5"/></svg> },
  { key: 'gym',             label: 'Gym',              icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6"><path d="M6.5 6.5h11M6.5 17.5h11M3 10h18M3 14h18M2 10v4M22 10v4"/></svg> },
  { key: 'store_room',      label: 'Store Room',       icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6"><path d="M20 12V22H4V12"/><path d="M22 7H2v5h20V7z"/><path d="M12 22V7M12 7H7.5a2.5 2.5 0 010-5C11 2 12 7 12 7zM12 7h4.5a2.5 2.5 0 000-5C13 2 12 7 12 7z"/></svg> },
  { key: 'servant_quarter', label: 'Servant Quarter',  icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6"><path d="M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg> },
  { key: 'drawing_room',    label: 'Drawing Room',     icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6"><rect x="3" y="8" width="18" height="12" rx="1"/><path d="M7 8V6a2 2 0 012-2h6a2 2 0 012 2v2"/><line x1="3" y1="14" x2="21" y2="14"/></svg> },
  { key: 'dining_room',     label: 'Dining Room',      icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6"><path d="M3 11l19-9-9 19-2-8-8-2z"/></svg> },
  { key: 'lawn',            label: 'Lawn / Garden',    icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6"><path d="M12 22V12M12 12C12 7 7 3 2 3c0 5 4 9 10 9zM12 12c0-5 5-9 10-9-1 5-5 9-10 9"/></svg> },
]
...
export default function AddPropertyPage() {
  ...
  // ── DB dropdown states ──
  const [dbCities, setDbCities] = useState<RefItem[]>([])
  const [dbAreas,  setDbAreas]  = useState<RefItem[]>([])
  const [dbTypes,  setDbTypes]  = useState<RefItem[]>([])
  ...
  // ── Fetch cities + types on mount ──
  useEffect(() => {
    fetch('/api/cities').then(r => r.json()).then(d => setDbCities(d.data || []))
    fetch('/api/types').then(r => r.json()).then(d => setDbTypes(d.data || []))
  }, [])

  // ── Fetch areas when city changes ──
  useEffect(() => {
    if (!form.city) { setDbAreas([]); return }
    fetch(`/api/areas?city=${form.city}`)
      .then(r => r.json())
      .then(d => setDbAreas(d.data || []))
  }, [form.city])
  ...
  const addNearbyItem = (cat: NearbyCategory) => {
    set('nearbyPlaces', { ...form.nearbyPlaces, [cat]: [...form.nearbyPlaces[cat], { name: '', time: '' }] })
  }
  ...
  const removeNearbyItem = (cat: NearbyCategory, i: number) => {
    set('nearbyPlaces', { ...form.nearbyPlaces, [cat]: form.nearbyPlaces[cat].filter((_, idx) => idx !== i) })
  }
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      fd.append('marla',           String(form.marla))
      fd.append('kanal',           String(form.kanal))
      ...
      fd.append('nearbyPlaces',    JSON.stringify(form.nearbyPlaces))
      if (form.mainPhoto) fd.append('mainPhoto', form.mainPhoto)
      for (const photo of form.additionalPhotos) fd.append('additionalPhotos', photo)

      const res  = await fetch('/api/properties', { method: 'POST', body: fd })
      const data = await res.json()
      if (!res.ok) { alert(`Error: ${data.message}`); return }
          ...
          <div>
            ...
            <select className={inputCls} value={form.propertyType}
              ...
              {dbTypes.length === 0
                ...
                : dbTypes.map(t => <option key={t._id} value={t._id}>{t.name}</option>)
              }
            </select>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <select className={inputCls} value={form.city}
                ...
                {dbCities.length === 0
                  ? <option disabled>Loading...</option>
                  : dbCities.map(c => <option key={c._id} value={c._id}>{c.name}</option>)
                }
              </select>
            </div>
            <div>
              ...
              <select className={inputCls} value={form.area}
                ...
                {dbAreas.map(a => <option key={a._id} value={a._id}>{a.name}</option>)}
              </select>
              {form.city && dbAreas.length === 0 && (
                <p className="text-[11px] text-amber-500 mt-1">
                  No areas found for this city.{' '}
                  <a href="/admin/areas/add" className="underline font-semibold">Add area</a>
                </p>
              )}
            </div>
          </div>
          ...
          <div>
            ...
            {mainPreview ? (
              ...
              <label className="border-2 border-dashed border-gray-200 rounded-lg p-8 flex flex-col items-center gap-2 cursor-pointer hover:border-[#042C53] transition group">
                <svg width="28" height="28" fill="none" stroke="#d1d5db" strokeWidth="1.5" viewBox="0 0 24 24" className="group-hover:stroke-[#042C53] transition">
              ...
              return (
                <button key={f.key} type="button" onClick={() => toggleFeature(f.key)}
                  className={`flex flex-col items-center gap-2 py-3 px-2 rounded-xl border-2 transition-all text-center cursor-pointer
                    ${checked ? 'border-[#042C53] bg-[#042C53] text-white shadow-sm' : 'border-gray-200 bg-white text-gray-500 hover:border-[#042C53] hover:text-[#042C53]'}`}>
                  ...
                  {checked && (
                    <span className="w-4 h-4 bg-white rounded-full flex items-center justify-center -mt-1">
                      <svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="#042C53" strokeWidth="3"><polyline points="20 6 9 17 4 12"/></svg>
                    </span>
                  )}
                </button>
              )
            ...
            {NEARBY_CATEGORIES.map(cat => (
              <button key={cat} type="button" onClick={() => setActiveNearby(cat)}
                className={`px-4 py-1.5 rounded-lg text-xs font-semibold transition-colors border
                  ${activeNearby === cat ? 'bg-[#042C53] text-white border-[#042C53]' : 'bg-white text-gray-500 border-gray-200 hover:border-[#042C53] hover:text-[#042C53]'}`}>
                {cat}
            ...
            {form.nearbyPlaces[activeNearby].map((item, i) => (
              <div key={i} className="flex gap-2 items-center">
                <input className={`${inputCls} flex-1`}
                  ...
                  value={item.name} onChange={e => updateNearbyItem(activeNearby, i, 'name', e.target.value)} />
                <input className="w-28 border border-gray-200 rounded-lg px-3 py-2.5 text-sm text-gray-800 placeholder-gray-300 focus:outline-none focus:border-[#042C53] focus:ring-1 focus:ring-[#042C53] transition"
                  placeholder="~3 min" value={item.time}
